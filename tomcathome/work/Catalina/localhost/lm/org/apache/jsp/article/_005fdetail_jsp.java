...
public final class _005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
 Article article = (Article) request.getAttribute("object"); 
      out.write("\r\n");
      out.write("\r\n");
      out.write("<table cellspacing=\"0\">\r\n");
      out.write("\t<tr><td class=\"note_top_left\"></td><td class=\"note_top\">");
      out.print( (article.getUpdatedBy() != null ? NamedI18nFrase.getText("created_by", "Oprettet af", request) + " " + article.getUpdatedBy().getName() + " - " : "") + Formatters.DD_MM_YYYY_HH_MM.format(article.getUpdated()) );
      ...
      out.print( article.getContent().getContent(WebApplication.getLocale(request)) );
      out.write("</div>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
